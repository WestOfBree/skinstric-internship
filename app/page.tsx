    ...
    <div className="min-h-screen bg-white text-black">
      ...
      <div className="p-6 sm:p-0">
        <main className="relative flex min-h-[calc(100vh-88px)] items-center justify-center px-6 md:px-12">
          <div className="absolute bottom-6 left-6 text-sm font-normal text-[#1A1B1C] md:bottom-16 md:left-12">
          ...
          <div
            id="left-section"
            className={`fixed left-0 top-1/2 h-0 w-0 origin-left scale-[0.38] translate-x-[-30%] transition-opacity duration-900 ease-in-out sm:scale-[0.48] sm:translate-x-[-24%] md:scale-[0.62] md:translate-x-[-18%] lg:scale-[0.76] lg:translate-x-[-12%] xl:scale-[0.88] xl:translate-x-[-6%] 2xl:scale-100 2xl:translate-x-0 ${
              activeCta === "right"
          ...
          <div
            id="main-heading"
            className="pointer-events-none relative z-10 h-55 w-full"
          >
            <h1
              className="relative h-55 text-[100px] font-inter font-normal leading-none tracking-lighter text-[#1A1B1C] opacity-100"
            >
              <span
          ...
          <div
            id="right-section"
            className={`fixed right-0 top-1/2 h-0 w-0 origin-right scale-[0.38] translate-x-[30%] transition-opacity duration-900 ease-in-out sm:scale-[0.48] sm:translate-x-[24%] md:scale-[0.62] md:translate-x-[18%] lg:scale-[0.76] lg:translate-x-[12%] xl:scale-[0.88] xl:translate-x-[6%] 2xl:scale-100 2xl:translate-x-0 ${
              activeCta === "left"
                ? "pointer-events-none opacity-0"
                : "opacity-100"
            }`}
